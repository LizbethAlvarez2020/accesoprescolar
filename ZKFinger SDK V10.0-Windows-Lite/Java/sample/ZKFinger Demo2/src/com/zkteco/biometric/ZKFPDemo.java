...
public class ZKFPDemo extends JFrame{
      ...
      //For End
		...
		btnRegImg.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String path = "huellas/fingerprint.bmp";
	...
	public static byte[] intToByteArray (final int number) {
		...
		{
			try {
				writeBitmap(imgBuf, fpWidth, fpHeight, "huellas/fingerprint.bmp");
				btnImg.setIcon(new ImageIcon(ImageIO.read(new File("huellas/fingerprint.bmp"))));
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
